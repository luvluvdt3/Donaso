                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea id="mytextarea2"
                                                name="purchase_guide"> {{ $siteinfo->purchase_guide }} </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea id="mytextarea3"
                                                name="privacy"> {{ $siteinfo->privacy }} </textarea>
                                        </div>
                                    </div>
...
<script src='https://cdn.tiny.cloud/1/xbxspxe6w1o18n1yyyasyep0uk01u7q2cgbhp2e3zigxj9fu/tinymce/5/tinymce.min.js'
