...
class ProductCartController extends Controller
{
    public function addToCart(Request $request)
    {
        ...
        if ($special_price == "") {
            ...
            $unit_price = $price;
        } else { //find unit price from bdd and calcul total_price
    ...
    public function CartOrder(Request $request)
    {
        ...
        foreach ($CartList as $CartListItem) {
            ...
            if ($resultInsert == 1) { //if succeeds then delete the items in the cart, (since the command is already saved in the bdd)
