...
//when admin is logged in -> move to /dashboard (in admin/index)
...
Route::prefix('subcategory')->group(function () {
    ...
    //the route name is like that
    //Will works on form like this:
...
Route::prefix('company')->group(function () {
    Route::get('/all', [RecycleCompanyController::class, 'GetAllAlerts'])->name('all.company');
});